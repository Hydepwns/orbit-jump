...
local tests = {
  ...
  ["should apply envelope"] = function()
    ...
    ModernTestFramework.assert.equal(soundData:getSampleCount(), envelopeData:getSampleCount(),
  ...
  ["should generate correct frequency sine wave"] = function()
    ...
    local expectedCrossings = 2 * freq * duration
    ModernTestFramework.assert.approx(expectedCrossings, zeroCrossings, 2,
      "Should have approximately correct zero crossings")
  end,
  ["should generate correct frequency square wave"] = function()
    ...
    ModernTestFramework.assert.approx(expectedTransitions, transitions, 4,
      "Should have approximately correct transitions")
  end,
  -- Edge cases
  ...
  ["should handle very short duration"] = function()
    ...
    -- 0.001 seconds * 44100 samples/second = 44.1, floored to 44
    ModernTestFramework.assert.equal(44, soundData:getSampleCount(), "Should have correct samples for short duration")
  end,
