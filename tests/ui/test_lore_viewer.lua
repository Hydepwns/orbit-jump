...
local mockArtifacts = {
    {
        ...
        lore = "This ancient crystal holds the secrets of the universe's creation. It pulses with primordial energy that predates the stars themselves.",
        discovered = true,
        requiresAll = false,
    ...
    },
    {
        id = 2,
        name = "Void Compass",
        lore = "A mysterious device that points to dimensions beyond our understanding. Its needle spins eternally, seeking paths through the cosmic void.",
        discovered = true,
        requiresAll = false,
    ...
    },
    {
        id = 3,
        name = "Stellar Codex",
        lore = "Written in a language of light and mathematics, this codex contains the fundamental laws that govern stellar evolution and death.",
        discovered = false,
        requiresAll = false,
    ...
    },
    {
        id = 4,
        name = "Final Truth",
        lore = "The ultimate artifact that reveals the purpose of existence itself. It can only be understood when all other truths have been gathered.",
        discovered = false,
        requiresAll = true,
...
-- Mock the ArtifactSystem module properly
package.loaded["src.systems.artifact_system"] = mockArtifactSystem

-- Clear any existing cache to ensure fresh loading
Utils.clearModuleCache()

local LoreViewer = require("src.ui.lore_viewer")
...
local tests = {
    ...
    ["test open to specific artifact"] = function()
        ...
        TestFramework.assert.equal(0, LoreViewer.scrollY, "Scroll should reset")
        TestFramework.assert.notEqual(nil, LoreViewer.selectedArtifact, "Should have artifact selected")
    ...
    ["test mouse click on artifact selects it"] = function()
        ...
        TestFramework.assert.equal(true, handled, "Should handle mouse click")
        TestFramework.assert.notEqual(nil, LoreViewer.selectedArtifact, "Should select artifact")
