...
local mockGraphics = {
    ...
    arc = function(mode, arctype, x, y, radius, angle1, angle2, segments)
    ...
    print = function(text, x, y)
        table.insert(graphicsCalls, {type = "print", text = text, x = x, y = y})
    end,
    
    printf = function(text, x, y, width, align)
        table.insert(graphicsCalls, {type = "printf", text = text, x = x, y = y, 
                                    width = width, align = align})
    end,
    
    setLineWidth = function(width)
        table.insert(graphicsCalls, {type = "setLineWidth", width = width})
    end,
    
    setFont = function(font)
        table.insert(graphicsCalls, {type = "setFont", font = font})
    end,
    ...
    push = function()
        table.insert(graphicsCalls, {type = "push"})
    end,
    ...
    translate = function(x, y)
        table.insert(graphicsCalls, {type = "translate", x = x, y = y})
    end,
    
    rotate = function(angle)
        table.insert(graphicsCalls, {type = "rotate", angle = angle})
    end
}

-- Replace love.graphics
love.graphics = mockGraphics
...
-- Require Renderer after mocks are set up
...
local tests = {
    ["test initialization"] = function()
        ...
        TestFramework.utils.assertEqual("regular_font", Renderer.fonts.regular, "Regular font should be set")
        TestFramework.utils.assertEqual("bold_font", Renderer.fonts.bold, "Bold font should be set")
        TestFramework.utils.assertEqual("light_font", Renderer.fonts.light, "Light font should be set")
        TestFramework.utils.assertEqual("extra_bold_font", Renderer.fonts.extraBold, "Extra bold font should be set")
    end,
    ...
    ["test draw background"] = function()
        ...
        TestFramework.utils.assertTrue(circleCount > 0, "Should draw star circles")
        ...
        TestFramework.utils.assertTrue(positionCount > 10, "Should draw stars at multiple positions")
    end,
    ...
    ["test draw player"] = function()
        ...
        TestFramework.utils.assertTrue(hasDrawCall("circle", function(call)
    ...
    ["test draw player with shield"] = function()
        ...
        local circleCount = countDrawCalls("circle")
        TestFramework.utils.assertTrue(circleCount >= 2, "Should draw shield circles")
    ...
    ["test draw player trail"] = function()
        ...
        local circleCount = countDrawCalls("circle")
        TestFramework.utils.assertEqual(3, circleCount, "Should draw circle for each trail point")
    end,
    ...
    ["test draw dash cooldown"] = function()
        ...
        TestFramework.utils.assertTrue(hasDrawCall("arc"), "Should draw cooldown arc")
    end,
    ...
    ["test draw planets"] = function()
        ...
        local circleCount = countDrawCalls("circle")
        TestFramework.utils.assertTrue(circleCount >= 2, "Should draw planet circles")
        
        -- Should draw rotation indicators (lines)
        TestFramework.utils.assertTrue(hasDrawCall("line"), "Should draw rotation indicators")
    end,
    ...
    ["test draw rings"] = function()
        ...
        TestFramework.utils.assertTrue(hasDrawCall("arc"), "Should draw ring arcs")
    ...
    ["test draw particles"] = function()
        ...
        local circleCount = countDrawCalls("circle")
        TestFramework.utils.assertEqual(3, circleCount, "Should draw circle for each particle")
    end,
    ...
    ["test draw pull indicator"] = function()
        ...
        TestFramework.utils.assertTrue(hasDrawCall("line"), "Should draw pull line")
        
        -- Should draw power indicator circle
        TestFramework.utils.assertTrue(hasDrawCall("circle"), "Should draw power indicator")
    end,
    ...
    ["test draw mobile controls"] = function()
        ...
        TestFramework.utils.assertTrue(hasDrawCall("circle"), "Should draw dash button")
        
        -- Should draw pause button
        TestFramework.utils.assertTrue(hasDrawCall("rectangle"), "Should draw pause button")
        
        -- Should draw text
        TestFramework.utils.assertTrue(hasDrawCall("printf"), "Should draw button text")
    end,
    ...
    ["test draw UI elements"] = function()
        ...
        -- Should draw score
        TestFramework.utils.assertTrue(hasDrawCall("print", function(call)
    ...
    ["test draw game over"] = function()
        ...
        TestFramework.utils.assertTrue(hasDrawCall("printf", function(call)
    ...
    ["test utility drawing functions"] = function()
        ...
        TestFramework.utils.assertTrue(#graphicsCalls > 0, "Utility functions should generate draw calls")
    end,
    ...
    ["test special ring effects"] = function()
        ...
        TestFramework.utils.assertTrue(hasDrawCall("circle"), "Should draw ring effects")
        TestFramework.utils.assertTrue(hasDrawCall("arc"), "Should draw ring arcs")
        
        -- Warp rings should use push/pop for rotation
        TestFramework.utils.assertTrue(hasDrawCall("push"), "Warp rings should use transform push")
        TestFramework.utils.assertTrue(hasDrawCall("pop"), "Warp rings should use transform pop")
...
-- Run the test suite
local function run()
    return TestFramework.runSuite("Renderer Tests", tests)
end
