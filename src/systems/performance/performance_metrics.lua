...
function PerformanceMetrics.updateFPS(currentFPS)
  ...
  if #PerformanceMetrics.history.fps_history > 3600 then -- 1 hour at 1 sample per second
...
function PerformanceMetrics.updateMemory()
  ...
  -- Keep history manageable
  if #PerformanceMetrics.history.memory_history > 3600 then
...
function PerformanceMetrics.recordLoadTime(loadType, duration)
  ...
  -- Keep history manageable
  if #PerformanceMetrics.history.load_time_history > 1000 then
...
function PerformanceMetrics.recordError(errorType, message, stackTrace)
  ...
  -- Keep history manageable
  if #PerformanceMetrics.history.error_history > 1000 then
