...
ArtifactSystem.artifacts = {
    {
        ...
        description = "The first explorers called it 'The Jump' - a technique discovered by accident when a pilot's gravity tether malfunctioned.",
    ...
    },
    {
        ...
        description = "They learned to harness momentum, to dance between gravity wells. Each jump became a calculated risk, a leap of faith.",
    ...
    },
    {
        ...
        description = "The rings appeared first around tech planets - geometric patterns that defied explanation. Were they beacons? Or warnings?",
    ...
    },
    {
        id = "void_whisper_1",
        name = "Void Whisper I",
        description = "The void planets repel all matter, yet something sleeps within. The first explorer to approach one reported hearing... music?",
    ...
    },
    {
        ...
        description = "Negative space. Inverted reality. The void planets shouldn't exist, yet here they are. What force created them?",
    ...
    },
    {
        id = "quantum_echo_1",
        name = "Quantum Echo I",
        description = "Reality shifts around quantum planets. Time flows differently. Some explorers report seeing themselves jump before they decide to.",
    ...
    },
    {
        ...
        description = "The quantum teleportation isn't random. There's a pattern, a purpose. The planets are connected by invisible threads.",
    ...
    },
    {
        ...
        description = "Day 47: The rings sing when collected in sequence. I've started mapping the melodies. There's something hidden in the harmony.",
    ...
    },
    {
        ...
        description = "Day 198: I've discovered warp zones - tears in space that lead to challenge dimensions. Who built these trials?",
    ...
    },
    {
        ...
        description = "The jumps, the rings, the planets - they're all connected. We're not exploring... we're remembering. This isn't space. This is—",
