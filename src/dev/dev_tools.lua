...
function DevTools.debugDraw.vectors()
    ...
    local planets = GameState.getPlanets()
    for _, planet in ipairs(planets) do
        local gx, gy = require("src.core.game_logic").calculateGravity(player.x, player.y, planet.x, planet.y, planet.radius)
...
function DevTools.runTests()
    ...
    local success, result = pcall(function()
        return require("tests.run_tests")
    end)
...
function DevTools.generateDocumentation()
    ...
    local success, result = pcall(function()
        local DocsGenerator = require("src.dev.docs_generator")
